...
//                     özellikle Alevi ve Bektaşi geleneğinde saygı gören bir halk
//                     erenidir. Yaşamı hakkında çok fazla ayrıntılı bilgi
//                     bulunmamakla birlikte, Kureyş Baba'nın ismi genellikle
//                     "Kureyş" kabilesine mensup olduğuna ve İslam'ın ilk
//                     yıllarında yaşamış bir kişi olduğuna işaret eder. Ancak bazı
//                     kaynaklar, onun Anadolu'ya yerleşmiş bir halk önderi ve
//                     mürşit olduğunu ve özellikle Alevi-Bektaşi toplulukları
//                     arasında manevi bir lider olarak kabul edildiğini belirtir.
//                     Kureyş Baba'nın adı, onun hem soyu hem de halk arasında
//                     kazandığı yüksek manevi kimlik nedeniyle önemlidir. O,
//                     insanlara hoşgörü, adalet ve eşitlik gibi değerleri
//                     öğretmiş, halkı bir arada tutmak için çeşitli manevi yol
//                     göstericiliklerde bulunmuştur.
//                   </p>
//                   <p />
//                 </div>
//               </div>
...
const Kultur = () => {
  ...
  useEffect(() => {
    const category1 = "Kültür-Ana-Yazı";
    const category2 = "Kültür-Yan-Yazı-1";
    const category3 = "Kültür-Yan-Yazı-2";
    const category4 = "Kültür";
    const category5 = "Kültür-En-Yeniler";
    const category6 = "Kültür-Alt-Yazı";
    const category7 = "Kültür-İlginizi-Çekebilir";
