...
//                   <p>
//                     Seyit Rıza, 20. yüzyılın başlarında Dersim (bugünkü Tunceli)
//                     bölgesinde önemli bir halk lideri ve Alevi-Bektaşi
//                     inançlarına mensup bir mürşit olarak tanınır. 1937-1938
//                     yıllarında Dersim İsyanı'nın önderlerinden biri olan Seyit
//                     Rıza, halkını Osmanlı'dan sonra Cumhuriyet dönemi
//                     otoritesine karşı savunmuş, bölgesel bağımsızlık ve dini
//                     özgürlük talepleriyle tanınmıştır. Seyit Rıza, aynı zamanda
//                     bir halk bilgesi ve manevi önderdir. Halk arasında büyük
//                     saygı gören, adaletli ve sevgi dolu bir lider olarak kabul
//                     edilir. İnançlı bir insan olarak, Alevi-Bektaşi öğretilerine
//                     dayanan bir yaşam sürmüş, halkını da bu değerlere göre
//                     yönlendirmiştir.
//                   </p>
//                   <p />
//                 </div>
...
// export default TarihselKisilikler;
...
const TarihselKisilikler = () => {
  ...
  useEffect(() => {
    const category1 = "Tarihsel-Kisilikler-Ana-Yazı";
    const category2 = "Tarihsel-Kisilikler-Yan-Yazı-1";
    const category3 = "Tarihsel-Kisilikler-Yan-Yazı-2";
    const category4 = "Tarihsel-Kisilikler";
    const category5 = "Tarihsel-Kisilikler-En-Yeniler";
    const category6 = "Tarihsel-Kisilikler-Alt-Yazı";
    const category7 = "Tarihsel-Kisilikler-İlginizi-Çekebilir";
