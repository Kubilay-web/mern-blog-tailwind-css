...
//                   <p>
//                     Pir Sultan Abdal, 16. yüzyılda yaşamış olan önemli bir Türk
//                     halk şairi, mutasavvıf ve Alevi-Bektaşi geleneğinin önde
//                     gelen isimlerinden biridir. Gerçek adıyla Haydar Sultan,
//                     Sivas'ın Banaz köyünde doğmuştur. Pir Sultan Abdal, derin
//                     bir mistik ve tasavvufi düşünceye sahipti ve şiirlerinde
//                     aşk, sevgi, insan hakları, adalet gibi evrensel temaları
//                     işlemiştir. Pir Sultan Abdal, özellikle Hakkın birliğine
//                     inancı, doğru bildiği yoldan sapmama kararlılığı ve Osmanlı
//                     İmparatorluğu'ndaki yönetimsel adaletsizliklere karşı duruşu
//                     ile tanınır. Alevi inançlarının savunucusu olarak, dinci
//                     otoritelere ve halkı baskı altında tutan yönetimlere karşı
//                     sert eleştirilerde bulunmuş, bu yüzden zaman zaman zor
//                     durumda kalmıştır. Sonunda, 1550'lerde Osmanlı yönetimi
//                     tarafından isyanlara katıldığı gerekçesiyle idam edilmiştir.
//                     Bugün Pir Sultan Abdal, hem halk edebiyatı hem de
//                     Alevi-Bektaşi kültüründe önemli bir figürdür. Şiirleri, Türk
//                     halk müziği repertuarında sıkça yer alır ve onun derin
//                     anlamlı dizeleri, halk arasında nesilden nesile
//                     aktarılmaktadır. Pir Sultan Abdal, özgürlük ve eşitlik
//                     mücadelesinin simgelerinden biri olarak, Anadolu'nun manevi
//                     ve kültürel mirasında önemli bir yer tutar.
//                   </p>
//                   <p />
//                 </div>
//               </div>
...
const Tarih = () => {
  ...
  useEffect(() => {
    const category1 = "Tarih-Ana-Yazı";
    const category2 = "Tarih-Yan-Yazı-1";
    const category3 = "Tarih-Yan-Yazı-2";
    const category4 = "Tarih";
    const category5 = "Tarih-En-Yeniler";
    const category6 = "Tarih-Alt-Yazı";
    const category7 = "Tarih-İlginizi-Çekebilir";
              ...
              <div className="card mb-0 border-0">
                ...
                <a href="/blog/gelecek-hatiralari/1607">
                  <img
                    ...
                    width="100%"
                    height="100%"
                    src="/images/Blog/34-Cemevi.jpg"
                    alt="Gelecek Hatıraları"
                  />
                </a>
                <div className="card-body">
                  <h3 className="bloglisttitle">Cemevi</h3>
                  <p className="bloglistsummary"></p>
                  <p>
                    Cemevi, Alevi inancına sahip olanların ibadetlerini yerine
                    getirdikleri, toplumsal ve dini hayatlarını organize
                    ettikleri bir yapıdır. Alevilikte, cemevi, sadece ibadet
                    yeri değil, aynı zamanda kültürel ve sosyal etkinliklerin de
                    gerçekleştirildiği bir merkezdir. Cemevlerinde, cem adı
                    verilen ibadetler yapılır, dua edilir, lokmalar paylaşılır
                    ve bir arada olmanın getirdiği dayanışma duygusu
                    güçlendirilir. Aleviler için cemevi, inançlarının
                    yaşatıldığı, toplumsal dayanışmanın sağlandığı ve
                    geleneklerin kuşaktan kuşağa aktarıldığı önemli bir
                    mekandır. Dersim'deki cemevleri de, bölgedeki Alevi toplumu
                    için hem dini hem de kültürel açıdan büyük bir öneme
                    sahiptir.
                  </p>
                  <p />
                </div>
