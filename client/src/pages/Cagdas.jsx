...
//     const category3 = "Cagdas-Tarih-İlginizi-Çekebilir";
...
const Cagdas = () => {
  ...
  useEffect(() => {
    const category1 = "Çağdaş-Ana-Yazı";
    const category2 = "Çağdaş-Yan-Yazı-1";
    const category3 = "Çağdaş-Yan-Yazı-2";
    const category4 = "Çağdaş";
    const category5 = "Çağdaş-En-Yeniler";
    const category6 = "Çağdaş-Alt-Yazı";
    const category7 = "Çağdaş-İlginizi-Çekebilir";
